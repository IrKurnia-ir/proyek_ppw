...
router.post('/', authMiddleware, roleMiddleware(['Admin', 'admin']), BookController.createBook);
router.put('/:id', authMiddleware, roleMiddleware(['Admin', 'admin']), BookController.updateBook);
router.delete('/:id', authMiddleware, roleMiddleware(['Admin', 'admin']), BookController.deleteBook);
